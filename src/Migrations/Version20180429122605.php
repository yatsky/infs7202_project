 ...
 */
class Version20180429122605 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE photo (id INT AUTO_INCREMENT NOT NULL, photo_name LONGTEXT NOT NULL, path VARCHAR(255) NOT NULL, upload_date DATETIME NOT NULL, price INT NOT NULL, size VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
